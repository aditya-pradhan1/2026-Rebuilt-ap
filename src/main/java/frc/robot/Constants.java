...
public final class Constants {
    ...
    public static final class DrivetrainConstants {
        ...
        public final static double MaxSpeed = 2.0 * TunerConstants.kSpeedAt12Volts.in(MetersPerSecond);
